Write-Output "DEPRECATED: Use php.ps1 7.3 to download PHP."
...
{
  If( $Link.href -match "/downloads/releases/php-7\.3\.\d+?-nts-Win32-VC15-x86\.zip" ){
    $phpUrl = (-join($phpBase, $Matches[0]))
  }
}

$phpIniUrl = "https://raw.githubusercontent.com/cretueusebiu/valet-windows/master/cli/stubs/php73.ini"
